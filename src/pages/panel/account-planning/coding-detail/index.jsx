...
import { CodingFlag } from "../coding-flag";
            ...
            >
              <div className="flex items-center py-2 pl-2 hover:bg-blue-50 dark:hover:bg-gray-700">
                ...
                >
                  ...
                  <span
                    className={`${
                      !subDetail.parent.parentId ? "w-[286px]" : "w-[264px]"
                    }`}
                  >
                    {subDetail.accountCode}
                  </span>
                  <div>{subDetail.accountName}</div>
                </div>
                <div className={`flex items-center gap-x-2`}>
                  {actions.map((action) => (
                    <>
                      {action.type === "delete" && (
                        <div
                          className="w-7 h-7 rounded-md bg-custom-gray flex items-center justify-center cursor-pointer"
                          onClick={() =>
                            deleteHandler(subDetail.finsmartCodingId)
                          }
                        >
                          <svg
                            width="19"
                      ...
                      {action.type === "map" && subDetail.parent.parentId && (
                        <div
                          className="w-7 h-7 rounded-md bg-custom-gray flex items-center justify-center cursor-pointer"
                          onClick={() => {
                            openModalHandler("mapper");
                            setDataModal(subDetail.finsmartCodingId);
                          }}
                        >
                          <SiOpenstreetmap
      ...
      {isLoading ? (
        ...
        <div>
          {planningDetailData.count > 0 ? (
            <div className="flex border-b-2 border-custom-gray -ml-1 mt-5 pb-5 font-semibold dark:text-dark_custom-full-white">
                      ...
                      <li key={planningDetail.finsmartCodingId}>
                        <div className="flex items-center hover:bg-blue-50 dark:hover:bg-gray-700">
                          ...
                          >
                            ...
                            <div>{planningDetail.accountName}</div>
                                ...
                                {action.type === "add" && (
                                  <div
                                    ...
                                    onClick={() => {
                                      ...
                                      setCode(planningDetail.accountCode);
                                    }}
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
