...
export const Confirm = ({ closeModal, isReload }) => {
  ...
  return (
    <>
      <div className="border-2 rounded-11 flex flex-col p-4 dark:text-custom-gray-light">
        {/* <h3 className="text-green-600 text-lg mb-6">
          {/* {t("text.company_created_successfully")}
        </h3> */}
      ...
      <div className="mt-14 flex justify-end gap-x-2">
        <Button
