...
import { CreateDefinitionType } from "./create";
import { EditDefinitionType } from "./edit";
...
export const DefinitionType = () => {
  ...
  const { info } = useSelector((state) => state.definitionTypeSlice);
  ...
  const deleteHandler = (id) => {
    axios
      .delete(api.SettingsApi.deleteDefinitionType + id)
      .then((res) => {
