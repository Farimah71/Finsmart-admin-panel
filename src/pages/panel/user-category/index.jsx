...
import { Button, Spinner, Table, Modal } from "../../../components";
import { useSelector } from "react-redux";
import { getUserCategories } from "../../../redux/actions/settings/user-category";
import { CreateUserCategory } from "./create";
import { EditUserCategory } from "./edit";
import { api } from "../../../api";
...
export const UserCategory = () => {
  ...
  const { info } = useSelector((state) => state.userCategorySlice);
  ...
  const deleteHandler = (id) => {
    axios
      .delete(api.SettingsApi.deleteUserCategory + id)
      .then((res) => {
