...
import { getRoles } from "../../../redux/actions/settings/role";
...
export const Role = () => {
  ...
  const { info } = useSelector((state) => state.roleSlice);
  ...
  const deleteHandler = (id) => {
    axios
      .delete(api.SettingsApi.deleteRole + id)
      .then((res) => {
