  ...
  return (
    <>
      {requestedCompany && !requestedCompany?.length && companyId && (
        <MdOutlineNotificationsNone size={21} className="mr-2" color="grey" />
      )}
      {requestedCompany && requestedCompany?.length > 0 && (
        <div className="relative">
          ...
          <div
            className={`absolute shadow-md w-[300px] transition-all duration-500 bg-white dark:bg-dark_custom-header-table-black text-white z-30 rounded-10 overflow-hidden -left-72 top-8 ${
              isShowNotif
          ...
          >
            <div className="flex gap-x-5 h-1/3 text-21 select-none bg-custom-blue-dark p-6 font-bold bg-[url('src/assets/images/digital-bg.png')] bg-no-repeat bg-cover">
              <span>{t("notif_popup.notifications")}</span>
