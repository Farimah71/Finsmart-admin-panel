    ...
    <div className="relative dark:bg-dark_custom-average-black">
      ...
      <PhoneInput
        inputProps={{
          ...
          className: `w-full h-10 dark:bg-dark_custom-average-black dark:text-dark_custom-full-white rounded-md border border-custom-gray text-custom-dark text-16 placeholder:text-14 placeholder:text-custom-gray-muted p-2 outline-none ${
            label && "mt-2"
          }`,
        }}
