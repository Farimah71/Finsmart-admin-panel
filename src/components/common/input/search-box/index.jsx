...
export const SearchBox = ({
  ...
  // ---------- render jsx ----------
  return (
    <div className={`relative w-full flex items-center ${classes}`}>
      {/* <svg
            width="22"
            height="22"
            viewBox="0 0 18 18"
      ...
      <Input
        ...
        classes="!h-10 placeholder:text-base pl-12"
        onChange={onChange}
        disabled={disabled}
        complex
      />
      ...
      <div className="absolute left-5 top-0 h-full rounded-48 flex items-center justify-center shadow-custom-blue-light">
        <RiSearch2Line size={20} color="#4287f5" />
      </div>
    </div>
  );
};
