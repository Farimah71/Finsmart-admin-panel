    ...
    <div className="w-full flex items-center gap-x-8">
      ...
      <div className="flex flex-col gap-y-4 dark:text-dark_custom-full-white">
        <label
          ...
          className={
            theme === "simple"
              ? "uppercase text-14 px-4 py-2 bg-custom-blue rounded-10 text-white cursor-pointer text-center"
              : "uppercase text-14 p-2 bg-white border border-custom-blue rounded-10 text-custom-blue cursor-pointer text-center"
          }
        >
          {label}
        </label>
